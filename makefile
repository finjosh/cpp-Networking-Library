...
LIB_SOURCE_DIRECTORIES=/src/Networking
#*****************************
#*****************************
...
ifeq ($(OS),Windows_NT)
	EXE:=.exe
	INCLUDE_DIRECTORIES=/VSCodeFolder/Libraries/SFML-3.0.0/include /VSCodeFolder/Libraries/TGUI-1.7/include /Git_projects/cpp-Utilities/include
	LIB_DIRECTORIES=/VSCodeFolder/Libraries/SFML-3.0.0/lib /VSCodeFolder/Libraries/TGUI-1.7/lib /Git_projects/cpp-Utilities/libs
	LINKER_FLAGS:=-utils -ltgui-s \
...
install:
	$(shell sudo cp -rf ${PROJECT_DIRECTORY}/include/Networking /usr/include)
